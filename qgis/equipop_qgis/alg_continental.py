...
#: v1.47.10, BACKLOG 298. How much of a feature a cell has to hold.
...
class ContinentalRasters(EquipopAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        # v1.47.10: POINTS, LINES OR POLYGONS. types=[0] meant points
    ...
    def _join(self, parameters, context, man, ch):
        ...
        v1.47.10, BACKLOG 298. Until now this took the CENTROID of
    ...
    def _join_centroid(self, src, tr, field, name, lat, table, man, ch,
                       join_to_points, snap_to_lattice):
        """The rule this box had before 1.47.10 - kept, because for
