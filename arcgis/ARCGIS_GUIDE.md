...
The last THREE are new in v1.47.7. Machines 3 and 4 had no help file
...
That is not hypothetical. It is how v1.47.7's new box, *Is a place
...
v1.47.7 writes the parameter comments as escaped HTML paragraphs.
...
(Before v1.47.7 this script could not run from your folder at all -
