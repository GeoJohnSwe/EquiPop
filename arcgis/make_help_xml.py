...
def load_toolbox():
    ...
    the five since 1.44.4 and, until 1.47.10, could not be run by the
...
def main(out_dir=None, plain=False):
    ...
    # BACKLOG 294. ALL FOUR TOOLS, from v1.47.10. Machines 3 and 4
    ...
    # EVERY REGISTERED TOOL, read from the Toolbox itself (v1.47.10).
