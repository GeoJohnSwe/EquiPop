...
HELP = {
    ...
    "unit": "The grid cell size in metres. Bigger cells mean fewer "
            ...
            "have.",
    "selfpot": "Self-potential: how far away the people in your OWN "
               "cell are. They are not standing on top of you, but "
               "up to and including 1.29.3 they were treated as if "
               "they were. That mattered wherever a single cell "
               "already held k people - a dense block, a large cell "
               "- because the radius came out as zero and k stopped "
               "making any difference: the nearest 100 and the "
               "nearest 1000 gave the same answer. Leave this at 1 "
               "and their distance is estimated by spreading them "
               "evenly over the cell, which recovers the radius you "
               "would have measured from individual points to within "
               "a fraction of a percent. Set it to 0.71 for the "
               "median distance instead of the radius, or to 0 to "
               "reproduce results from 1.29.3 and earlier exactly.",
